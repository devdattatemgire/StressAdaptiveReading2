...
const socket = new WebSocket('ws://192.168.169.2:8765/ws/sensor');
        ...
        function startSensor() {
            socket.send(JSON.stringify({'action': 'start_sensor'}));
        }

        function stopSensor() {
            socket.send(JSON.stringify({'action': 'stop_sensor'}));
        }

        function connectRaspi() {
